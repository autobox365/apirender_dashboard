...
const CustomerDetail = ({ history, user }) => {
  ...
  const [emailPreference] = useState(user.email_preference);
  ...
  const initialValues = { firstName, lastName, email, emailPreference, confirmPassword, password, companyName, jobTitle, country, role, phoneNumber };
                    ...
                    <FormGroup row>
                      ...
                      <Colxx sm={6}>
                        <FormGroup className="form-group has-float-label  mb-4">
                          ...
                          />
                          {errors.emailPreference && touched.emailPreference && (
                            <div className="invalid-feedback d-block">
